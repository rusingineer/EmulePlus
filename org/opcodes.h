...
// Version strings
#define CURRENT_VERSION	"1.2d alpha"
...
#define CURRENT_PLUS_VERSION	0x0124
...
// Constants
#define PLUS_VERSION_STR		"Plus 1.2d"
#define WS_SERVER_TOKEN			"eMulePlus/1.2d"
...
#define UPLOAD_CLIENT_DATARATE	3200
...
#define BADCLIENTBAN			g_App.m_pPrefs->BadClientMinRequestNum()
...
typedef EnumDomain<_EnumFileTags>	EnumFileTags;
...
// unknown client tags (friendsharing, DarkMule, ...)
	CT_UNKNOWNx0			= 0x00, // Hybrid Horde protocol
	CT_UNKNOWNx22			= 0x22, // DarkMule |eVorte|X|
	CT_UNKNOWNx3c			= 0x3c, // Pawcio
	CT_UNKNOWNx3d			= 0x3d, // Pawcio
	CT_UNKNOWNx69			= 0x69, // DarkMule v6 |eVorte|X|
	CT_UNKNOWNx84			= 0x84, // eChamblard 4.x
	CT_UNKNOWNx85			= 0x85, // eChamblard 4.x
	CT_UNKNOWNx86			= 0x86, // eChamblard 4.x
	CT_UNKNOWNx87			= 0x87, // eChamblard 4.2
	CT_UNKNOWNx88			= 0x88, // DarkMule v6 |eVorte|X|
	CT_UNKNOWNx94			= 0x94, // O² 2.x
...
// identified MOD's
	...
	ET_MOD_FUSION				= 0x66,
	ET_MOD_FUSION_VERSION		= 0x67,
	ET_MOD_TAROD				= 0x77,
	ET_MOD_TAROD_VERSION		= 0x78,
	ET_MOD_Morph				= 0x79,
	ET_MOD_Morph_VERSION		= 0x80,
	ET_MOD_MorTillo				= 0x82,
	ET_MOD_MorTillo_VERSION		= 0x83,
	ET_MOD_LSD					= 0x87,
	ET_MOD_LSD_VERSION			= 0x88,
	ET_MOD_LOVELACE_VERSION		= 0x90,
	ET_MOD_OXY					= 0x94,
...
// unknown eMule tags
	...
	ET_MOD_UNKNOWNx41			= 0x41, // CrewMod (pre-release mod based on Plus) identification
	ET_MOD_UNKNOWNx42			= 0x42, // CrewMod (pre-release mod based on Plus) key verification
	ET_MOD_UNKNOWNx43			= 0x43, // CrewMod (pre-release mod based on Plus) version info
	...
	ET_MOD_UNKNOWNx5C			= 0x5C, // LSD-MOD
	...
	ET_MOD_UNKNOWNx91			= 0x91, // DarkMule v6 |eVorte|X|
	ET_MOD_UNKNOWNx92			= 0x92, // DarkMule v6 |eVorte|X|
	ET_MOD_UNKNOWNxA0			= 0xA0, // --CeeK--(eMule v0.28)
	ET_MOD_UNKNOWNxA1			= 0xA1, // eMule v0.30 [eWombatBeta 0.064.A]
...
#define Irc_AddFriend			10291
#define Irc_SendLink			10292
#define Irc_SetSendLink			10293
